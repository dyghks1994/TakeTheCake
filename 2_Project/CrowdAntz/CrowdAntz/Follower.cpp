...
void Follower::Rotate(const float dTime)
{
	...
	Vector4 _v1 = Vector4(m_DirVec.x, m_DirVec.z, 0, 0);
	Vector4 _v2 = Vector4(0, 1.0f, 0, 0);
	Vector2 _result = XMVector2AngleBetweenVectors(_v1, _v2);

	m_Angle = _result.x * (180.0f / 3.1415f);	// radian to degree
