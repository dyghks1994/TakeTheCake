...
/// 안쓰는중
IDXObjectBase* DXObjectFactory::CreateObject(string name, eDXObjectType type)
{
   //IDXObjectBase* _newObject;

   switch (type)
   {
      case eDXObjectType::ASEMesh:
      {

      }
      break;

      case eDXObjectType::LineList:
      {

      }
      break;

      case eDXObjectType::TriangleList:
      {
