...
class Lexer : public AlignedAllocationPolicy<16>
{
protected:
   // 파일을 읽어서 작업하기 위한 변수들
   HANDLE m_hFile; // 파일의 핸들

   DWORD m_BufferPointer; // 현재 Buffer상에 읽고 있는 문자열의 Pointer
   DWORD m_NowLoadedBuffer; // 현재 읽어 들여놓은 크기
