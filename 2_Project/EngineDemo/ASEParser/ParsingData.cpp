...
Scenedata::Scenedata()
{
	...
	m_MeshFrameStep = 0;
	m_KeyFrameStep = 0;
	m_SceneBackgroundStatic = Vector3(0, 0, 0);
	m_SceneAmbientStatic = Vector3(0, 0, 0);
}
...
Bone::Bone()
	:m_BoneNumber(0), m_boneTM_NodeTM(), m_boneTM_WorldTM()
{
...
Mesh::Mesh()
{
	...
	// animation
	m_IsPosAnimated = false;
	m_IsRotAnimated = false;

	m_pParentMesh = nullptr;
	m_OptimizedIndices = nullptr;

	m_IsBone = false;
	m_Bone = nullptr;
	m_WeightVertex = nullptr;
	/// Skinning Object
	// SKIN_INITTM은 무시하고
	// TM_ROW0~3
	// BONE_LIST
