...
Texture2D gNormalMap; // 노말맵 추가 현재게임에 안쓰임
...
float4 PS(VertexOut pin,
          ...
          uniform bool gReflectionEnbled) : SV_Target
{
...
technique11 PosNormal
{
   pass P0
   {
      SetVertexShader(CompileShader(vs_5_0, PNVS()));
